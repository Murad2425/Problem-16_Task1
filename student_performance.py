...
Original file is located at
    https://colab.research.google.com/drive/1iruk2fdkGPQ0bPRYIKJ5w_STt6yk9mPc
"""
...
if 'Date' in df.columns:
    # Check if there are any rows with the given Student ID
    student_data = df[df['Student ID'] == 'STU-12345']
    if not student_data.empty:
        student_data.plot(x='Date', y='Score', kind='line', title="Performance Trend")
        plt.show()
    else:
        print(f"No data found for Student ID 'STU-12345'")
else:
    print(f"The 'Date' column does not exist in the DataFrame.")
